...
#        assert X_test.shape[0] == test_end - test_start, X_test.shape
  ...
  adv_new = fgsm.generate_np(x_new, **fgsm_params)

  ori = np.squeeze(adv_new[0], axis=2)
  print("Original array:", ori)
  print("Shape:", ori.shape)
  print("Type:", type(ori[3, 3]))

  # skimage
  """
  from skimage.io import imsave, imread
  imsave("skimage-0.png", adv_new[0])

  img = imread("skimage-0.png")
  img = np.divide(img, 255)
  print("Loaded array:", img)
  ...
  #img = img[..., ::-1]
  orig = ori[..., ::-1]
  plt.imsave("skimage-1.png", orig.astype(int), cmap='gray', vmin=0,vmax=255)

  img = imread("skimage-1.png")
  #img = np.divide(img, 255)
  print("Loaded array:", img)
  print("Shape:", img.shape)
  """
  ...
  for i in range(0, 100):
    tiffile.imsave("/home/dinhtv/code/adversarial-images/fgsm/adversarial/adv_%d.tif" % i, adv_new[i])
    tiffile.imsave("/home/dinhtv/code/adversarial-images/fgsm/test/adv_%d.tif" % i, adv_new[i])

  """
  from keras.preprocessing import image
  img = image.img_to_array(image.load_img("skimage-2.png", target_size=(28, 28), grayscale = True))
